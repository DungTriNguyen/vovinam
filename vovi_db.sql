...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2024 at 10:46 AM
...
--
-- Table structure for table `capdai`
--
...
--
-- Table structure for table `chitietketquathi`
--
...
--
-- Dumping data for table `chitietketquathi`
--
...
--
-- Table structure for table `ctphieudiem`
--
...
--
-- Dumping data for table `ctphieudiem`
--
...
(1, 1, 1, 1, 1, 8.5, 7.5, 8, 8.5, 32.5, 1, 'gk1', 1, 'Ghi chú phiếu điểm 1', '2024-08-01'),
(2, 2, 2, 2, 2, 7, 6.5, 6.5, 7, 27, 0, 'gk2', 2, 'Ghi chú phiếu điểm 2', '2024-08-05'),
(3, 3, 3, 3, 3, 9, 8.5, 8.5, 9, 35, 1, 'gk3', 3, 'Ghi chú phiếu điểm 3', '2024-08-10'),
(4, 4, 4, 4, 4, 6, 5.5, 6, 6.5, 24, 0, 'gk4', 4, 'Ghi chú phiếu điểm 4', '2024-08-12'),
(5, 5, 5, 5, 5, 8, 7.5, 8, 8.5, 32, 1, 'gk5', 5, 'Ghi chú phiếu điểm 5', '2024-08-15'),
(6, 6, 6, 6, 6, 7.5, 7, 7.5, 7, 29.5, 0, 'gk6', 6, 'Ghi chú phiếu điểm 6', '2024-08-18');
...
CREATE TABLE `ketquathi` (
  ...
  `ghiChu` varchar(255) DEFAULT NULL,
  `ngayCham` date DEFAULT NULL,
  `fileDuThi` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `ketquathi` (`maKetQuaThi`, `maMonSinh`, `maKhoaThi`, `capDaiHienTai`, `capDaiDuThi`, `ketQua`, `trangThaiHoSo`, `ghiChu`, `ngayCham`, `fileDuThi`) VALUES
(1, 1, 1, 1, 2, 1, 1, 'Đạt yêu cầu', '2024-08-01', NULL),
(2, 2, 2, 2, 3, 0, 0, 'Không đạt yêu cầu', '2024-08-05', NULL),
(3, 3, 3, 3, 4, 1, 1, 'Đạt yêu cầu', '2024-08-10', NULL),
(4, 4, 4, 4, 1, 0, 0, 'Ghi chú kết quả thi 4', '2024-08-12', NULL),
(5, 5, 5, 1, 2, 1, 1, 'Ghi chú kết quả thi 5', '2024-08-15', NULL),
(6, 6, 6, 2, 3, 1, 1, 'Ghi chú kết quả thi 6', '2024-08-18', NULL),
(20, 5, 4, 5, 4, 0, 0, 'Không đạt yêu cầu', '2024-08-01', 'kkkk'),
(30, 5, 4, 5, 4, 1, 0, 'Ghi chú mẫu', '2024-08-01', 'kkkk'),
(100, 5, 4, 5, 4, 1, 0, 'Ghi chú mẫu', '2024-08-01', 'kkkk'),
(101, 5, 4, 5, 4, 1, 0, 'Ghi chú mẫu', '2024-08-01', 'kkkk');
...
--
-- Table structure for table `khoathicapdai`
--
...
--
-- Dumping data for table `khoathicapdai`
--
...
--
-- Table structure for table `monsinh`
--
...
--
-- Dumping data for table `monsinh`
--
...
(1, 1, 'Nguyen Van A', 1, '2000-01-01', 170, 60, '123 Duong ABC, Quan X', '0123456789', 'nguyenvana@example.com', '123456789012', 'anhcccd1.jpg', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-01-01', 'TPHCM', 'Nguyen Thi B', '0987654321', 'Giao Vien', 'Tap Luyen 2023', 'Thi 2023', 'Cao Dang', '12', 'Kha nang tot', 1, 1, 1),
(2, 2, 'Le Thi B', 0, '1999-02-02', 165, 55, '456 Duong XYZ, Quan Y', '0987654321', 'lethib@example.com', '234567890123', 'anhcccd2.jpg', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-02-01', 'Hanoi', 'Le Van C', '0976543210', 'Sinh Vien', 'Tap Luyen 2022', 'Thi 2022', 'Dai Hoc', '10', 'Kha nang tot', 1, 2, 2),
(3, 3, 'Tran Van C', 1, '1998-03-03', 175, 70, '789 Duong DEF, Quan Z', '0765432109', 'tranvanc@example.com', '345678901234', 'anhcccd3.jpg', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-03-01', 'Danang', 'Tran Thi D', '0765432108', 'Kinh Doanh', 'Tap Luyen 2021', 'Thi 2021', 'Cao Dang', '8', 'Kha nang tot', 0, 3, 3),
(4, 4, 'Hoang Thi D', 0, '2001-04-04', 160, 50, '101 Duong GHI, Quan A', '0654321098', 'hoangthid@example.com', '456789012345', 'anhcccd4.jpg', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-04-01', 'Haiphong', 'Hoang Van E', '0654321097', 'Nhan Vien', 'Tap Luyen 2020', 'Thi 2020', 'Cao Dang', '9', 'Kha nang tot', 0, 4, 4),
(5, 5, 'Pham Van E', 1, '2002-05-05', 180, 75, '202 Duong JKL, Quan B', '0543210987', 'phamvane@example.com', '567890123456', 'anhcccd5.jpg', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-05-01', 'Cantho', 'Pham Thi F', '0543210986', 'Sinh Vien', 'Tap Luyen 2019', 'Thi 2019', 'Trung Hoc', '11', 'Kha nang tot', 0, 5, 1),
(6, 6, 'Vo Thi F', 0, '2003-06-06', 155, 48, '303 Duong MNO, Quan C', '0432109876', 'vothif@example.com', '678901234567', 'anhcccd6.jpg', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-06-01', 'Hue', 'Vo Van G', '0432109875', 'Giao Vien', 'Tap Luyen 2018', 'Thi 2018', 'Trung Hoc', '13', 'Kha nang tot', 0, 6, 2),
(7, 0, 'udng', 1, '2024-08-07', 123, 325, 'sdfsdds', '0923324491', 'dungtringuyen113@gmail.com', '2534534654654', '[\"../image/monsinh/monsinh-2534534654654/monsinh-cccd-2.jpg\"]', '[\"../image/monsinh/monsinh-2534534654654/monsinh-3x4-1.jpg\"]', '2024-08-01', 'ssaas', 'sà', '0986407990', 'sàdsafdasf', 'sầdf', 'dàdsf', 'ssdfsdfsdf', 'sdfsdfsd', 'sdfsdf', 0, 3, 3);

-- --------------------------------------------------------

--
-- Stand-in structure for view `monsinhcaulacbo`
-- (See below for the actual view)
--
CREATE TABLE `monsinhcaulacbo` (
`maMonSinh` int(11)
,`hoTen` varchar(255)
,`maThe` int(11)
,`tenCauLacBo` varchar(255)
,`maCauLacBo` int(11)
);
...
('admin', 'Hoang', 'Hong', '123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-15 16:42:49', 1, '0912345679', 'quantri', NULL),
('gk1', 'Hoang', 'Hongsd', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-17 01:45:11', 0, '0912345679', 'giamkhaosongluyen', NULL),
('gk2', 'Hoang', 'Hongâ', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-17 01:45:14', 1, '0912345679', 'giamkhaocanban', NULL),
('gk3', 'Hoang', 'Hongx', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-14 11:12:05', 1, '0912345679', 'giamkhaodoikhang', NULL),
('gk4', 'Hoang', 'Hongz', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345679', 'giamkhaotheluc', NULL),
('gk5', 'Hoang', 'Hongc', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345679', 'giamkhaolythuyet', NULL),
('gk6', 'Hoang', 'Hongb', '123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345679', 'quantri', NULL),
('judgehong', 'Hoang', 'Hong', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345679', 'giamkhaodonluyen', NULL),
('nguyenvana', 'Nguyen', 'Van A', 'password123', 'avatar.jpg', 'STUDENT', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345678', 'huanluyenvientruongclb', 1),
('truongclbB', 'Hoang', 'Hong2', 'password123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345679', 'huanluyenvientruongclb', 2),
('truongclbC', 'Hoang', 'Hong3', '123', 'avatar.jpg', 'JUDGE', '2024-08-09 19:39:30', '2024-08-09 19:39:30', 1, '0912345679', 'huanluyenvientruongclb', 3);

-- --------------------------------------------------------

--
-- Structure for view `monsinhcaulacbo`
--
DROP TABLE IF EXISTS `monsinhcaulacbo`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `monsinhcaulacbo`  AS SELECT `ms`.`maMonSinh` AS `maMonSinh`, `ms`.`hoTen` AS `hoTen`, `ms`.`maThe` AS `maThe`, `clb`.`tenCauLacBo` AS `tenCauLacBo`, `clb`.`maCauLacBo` AS `maCauLacBo` FROM (`monsinh` `ms` join `caulacbo` `clb` on(`ms`.`maCauLacBo` = `clb`.`maCauLacBo`)) ;
...
--
-- Indexes for table `chitietketquathi`
--
...
--
-- Indexes for table `khoathicapdai`
--
...
--
-- AUTO_INCREMENT for table `capdai`
--
ALTER TABLE `capdai`
  MODIFY `maCapDai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `chitietketquathi`
--
ALTER TABLE `chitietketquathi`
  MODIFY `maChiTietKetQua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ctphieudiem`
--
ALTER TABLE `ctphieudiem`
...
--
ALTER TABLE `ketquathi`
  MODIFY `maKetQuaThi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
-- AUTO_INCREMENT for table `monsinh`
--
ALTER TABLE `monsinh`
  MODIFY `maMonSinh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Constraints for table `chitietketquathi`
--
ALTER TABLE `chitietketquathi`
...
--
-- Constraints for table `ctphieudiem`
--
ALTER TABLE `ctphieudiem`
...
--
-- Constraints for table `khoathicapdai`
--
ALTER TABLE `khoathicapdai`

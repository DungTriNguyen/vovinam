...
function setUpPermission(dataPermissionDetail, codePermission) {
  ...
  let monsinh_Permission = document.getElementById(
    "monsinh-management-sidebar"
  );
  let khoathi_Permission = document.getElementById(
    "khoathi-management-sidebar"
  );
  let ketquathi_Permission = document.getElementById(
    "ketquathi-management-sidebar"
  );
  // let payment_Permission = document.getElementById(
  //   "payment-management-sidebar"
  // );
  // let product_Permission = document.getElementById(
  //   "product-management-sidebar"
  // );
  // let size_Permission = document.getElementById("size-management-sidebar");
  // let supplier_Permission = document.getElementById(
  //   "supplier-management-sidebar"
  // );
  // let transport_Permission = document.getElementById(
  //   "transportation-management-sidebar"
  // );

  // một số chức năng thêm
  // let add_account_Permission = document.getElementById(
  //   "add-user-management-sidebar"
  // );
  // let add_product_Permission = document.getElementById(
  //   "add-product-management-sidebar"
  // );
  // let add_supplier_Permission = document.getElementById(
  //   "add-supplier-management-sidebar"
  // );
  // let add_payment_Permission = document.getElementById(
  //   "add-payment-management-sidebar"
  // );
  // let add_transport_Permission = document.getElementById(
  //   "add-transportation-management-sidebar"
  // );
  ...
  for (let item of dataPermissionDetail) {
    ...
    if (item.functionCode == "transport" && item.seePermission == "1") {
      ...
      if (item.functionCode == "transport" && item.addPermission == "1") {
        ...
        item.functionCode == "transport" &&
        item.addPermission != "1"
      ) {
...
// hàm được dùng để hiện các chức năng phân quyền

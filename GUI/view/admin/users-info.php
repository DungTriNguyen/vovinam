                    ...
                    <form method="POST" action="">
                        <div class="row">
                            <div class="col-6 form-group mb-3">
                                ...
                                <input id="username" class="form-control" type="text" disabled name="username"
                                    placeholder="Nhập họ tên" value="Tien Hai Le">
                            </div>
                            <div class="col-6 form-group mb-3">
                            ...
                            <div class="col-6 form-group mb-3">
                                ...
                                <input id="mail" class="form-control" type="text" name="email"
                                    placeholder="Nhập email..." value="tienhai4888@gmail.com">
                            </div>

                            <div class="col-6 form-group mb-3">
                                <label class="mb-1 fs-5" for="">Số điện thoại</label>
                                <input id="phone" class="form-control" type="text" name="phone"
                                    placeholder="Nhập số điện thoại..." value="0987982144">
                            </div>
                            ...
                            <div class="col-6 form-group mb-3">
                                ...
                                <input id="address" class="form-control" type="text" name="address"
                                    ...
                                    value="330/18/13 Âu Dương Lân, phường 3, Quận 8, tp HCM">
                            </div>
                        </div>
                        <button id="submit" onclick="submitChangeInfor(event)" type="submit" class="btn btn-primary">Cập
                            nhật</button>

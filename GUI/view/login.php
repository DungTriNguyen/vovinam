                ...
                <div class="form-inner-cont">
                    ...
                    <form action="" method="post" class="signin-form">
                        <div class="form-input">
                            <span class="fa fa-envelope" aria-hidden="true"></span> <input id="userNameInput" type="text" name="email" placeholder="Tên tài khoản" required />
                        </div>
                        <div class="form-input">
                    ...
                    <!-- <p class="signup">Do not have an account? <a href="../../GUI/view/signup.php"
                            class="signuplink">Register now</a></p> -->
